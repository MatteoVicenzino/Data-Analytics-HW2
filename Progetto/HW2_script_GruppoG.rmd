...
```{r}
case <- read.csv("train.csv", stringsAsFactors = TRUE)
banche <- read.csv("credit_card.csv")
```
...
calcolo_cov_cor <- function(variabile_numerica) {
  c(cov = cov(variabile_numerica, case$SalePrice, use = "complete.obs"), cor = cor(variabile_numerica, case$SalePrice, use = "complete.obs"))
}
# Funzione per le Variabili Qualitative
