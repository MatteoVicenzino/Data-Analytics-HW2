...
che  in questo caso vediamo essere principalmente Devianza "Entro". Eta Quadro è infatti 0.246
...
in una scala di interi che va da 1 a 10. Può anche esserve vista come una variabile 
...
salga. Volendo comunques usare la correlazione lineare con questa variabile, vediamo che essa 
...
in una scala di interi che va da 1 a 10. Come "OverallQual", può anche esserve vista come una variabile 
Qualitativa ordinabile divisa in 10 classi.
Si vede anche dal grafico che la moda è "5" con più del 50%delle osservazizoni. Si nota che media e mediana 
