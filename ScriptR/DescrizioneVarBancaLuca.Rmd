...
Variabile Quantitativa che indica l'area della proprietà. Ha un range di valori molto alto dovuto principalmente alla fresenza di valori estremi 
che arrivano ad un massimo di 2.152450e+05. 
...
il gruppo "Lvl" non comprendesse 90% delle osservazioni, tutte le medie dei gruppi sono molto vicine a quella generaleù. I gruppi hanno range di valori simili  fatta eccezione 
...
formati da al 6 proprietà, non abbiamo una sample size abbastanza grande per fare previsioni sul comportamento della variabile "SalePrice" al variare di
"Condition2".
