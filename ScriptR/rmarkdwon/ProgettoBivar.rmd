...
La variabile ExterQual influenza fortemente il prezzo di una casa. Si può infatti notare che il rapporto tra la la devianza between e la devianza totale è di 0.4 .
...
Questo si può notare anche dal valore di ETA^2 che è molto basso, dello 0.19% dovuto alla codevianza between molto bassa
